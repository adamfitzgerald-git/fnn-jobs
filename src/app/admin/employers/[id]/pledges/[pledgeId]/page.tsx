...
export default async function EditPledgePage({
  params,
}: {
  params: Promise<{ id: string; pledgeId: string }>;
}) {
  ...
  const pledge = await prisma.commitmentPledge.findUnique({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <PledgeForm pledge={pledge} employerId={id} />
    </div>
  );
}
